...
BOMul::BOMul() :Operation("mul",1), constant_num_(1)
{
}


bool BOMul::ValidateAndSetParams(std::string params)
{
	std::regex rx("[ ]*([0-9]+)[ ]*");
	std::smatch result;
...
void BOMul::Execute(std::vector<int>& layer, const std::map<std::pair<unsigned, unsigned>, unsigned>& selected_pixels_)
{
